...
const Search = ({search}: SearchPropsType) => {
    const [name, setName] = useState("");

    return (
        <div>
            <form className="max-w-md mx-auto" method="GET" onSubmit={(event) => search(event, name)}>
                ...
                <div className="relative">
                    ...
                    <input type="search" id="default-search" value={name} onChange={(e) => setName(e.target.value)}
